...
def train(args, model, device, train_loader, criterion, optimizer, epoch, writer):
    ...
    for batch_index, (data, target) in enumerate(train_loader):
        ...
        optimizer.step()
        # print log
        total_loss_per_interval += loss.item()
        if batch_index % args.log_interval == (args.log_interval - 1):
            ...
            writer.add_image('output', img_grid, global_step)
            
            writer.add_scalar('training loss',
                            total_loss_per_interval / args.log_interval,
                            global_step)
            total_loss_per_interval = 0.0
